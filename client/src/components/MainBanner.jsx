    ...
    <div className='relative'>
        ...
        md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
            ...
            md:max-w-80 lg:max-w-105 leading-tight lg:leading-15'>
               Farm-Fresh Finds, Wallet-Friendly Prices!
                 </h1>
       
        <div className='flex items-center mt-6 font-medium'>
            <Link to={"/products"} className="group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary
            hover:bg-primary-dull transition rounded text-white coursor-pointer">Shop now
            <img className='md:hidden transition group-focus:translate-x-1' src={assets.white_arrow_icon} alt="arrow"/>
            </Link>

            <Link to={"/products"} className="group hidden md:flex items-center gap-2 px-9 py-3 coursor-pointer">Explore Deals
